  ...
  <Layout>
    <div class="flex items-center justify-center min-h-screen">
      <div class="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        <h1 class="text-2xl font-bold text-center text-gray-800 dark:text-white">登录</h1>
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div>
            <button type="submit" class="w-full px-4 py-2 font-bold text-white bg-blue-600 rounded-md hover:bg-blue-700">登录</button>
          </div>
        </form>
      </div>
    </div>
